...
SET SPARK_DRIVER_OPTIONS=-Dlog4j.configuration=file://%SPARK_DIR%\conf\log4j.properties
rem export SPARK_DRIVER_OPTIONS="-agentlib:jdwp=transport=dt_socket,server=y,suspend=y,address=5005 -Dlog4j.configuration=file://$SPARK_DIR/conf/log4j.properties"


echo %SPARK_SUBMIT% --driver-java-options "%SPARK_DRIVER_OPTIONS%" --class %COMET_MAIN% %COMET_BIN% %*
